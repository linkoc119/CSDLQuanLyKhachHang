...
ALTER TABLE HoaDon
    ADD CONSTRAINT FK_HoaDon_MaKH FOREIGN KEY (MaKH) REFERENCES KhachHang(MaKH) ON DELETE CASCADE,
    ADD CONSTRAINT FK_HoaDon_MaNha FOREIGN KEY (MaNha) REFERENCES NhaChoThue(MaNha) ON DELETE CASCADE,
